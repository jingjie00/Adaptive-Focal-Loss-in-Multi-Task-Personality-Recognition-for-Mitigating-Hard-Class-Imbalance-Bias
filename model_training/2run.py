...
def train(loss_function, epochs, trainloader, validationloader, testloader, test_flag):
    ...
    for e in range(epochs):
        ...
        for inputs, labels in (validationloader if test_flag == False else testloader):
    ...
    if test_flag == True:
        ...
        epochs = model.getOptEpoch()
        return train(loss_function = loss_function, epochs= epochs, trainloader=trainloader,testloader = testloader, validationloader=validationloader, test_flag=True)
...
def run(config):
    ...
    for dimension in models.keys():
        ...
        model = train(loss_function = loss_function, epochs= config["epochs"], trainloader=trainloader,testloader = testloader, validationloader=validationloader, test_flag=False)
